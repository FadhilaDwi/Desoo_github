...
<section class="blog bgwhite p-t-80 p-b-60">
	<div class="container">
		<?php echo form_open_multipart(base_url('Berita')) ?>
		<div class="row">
			<div class="col-6 col-md-3 p-b-30 m-l-r-auto input-group">
				<input type="text" name="cari" class="form-control border" placeholder="Cari Berita" >
				<button type="submit" class="btn btn-search-black">
