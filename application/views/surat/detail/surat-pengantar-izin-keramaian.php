				...
				<?php 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>Nama Acara</th>
								<td><input type="text" name="var1" class="form-control" placeholder="Nama Acara" required>
									<p class="font-weight-light text-success">*Contoh : Resepsi Pernikahan</p>
								</td>
							</tr>
							<tr>
								<th>Hari</th>
								<td><input type="text" name="var2" class="form-control" placeholder="Hari" required>
									<p class="font-weight-light text-success">*Contoh : Sabtu</p>
								</td>
							</tr>
							<tr>
								<th>Tanggal</th>
								<td><input type="date" name="var3" class="form-control" placeholder="Tanggal" required>
									<p class="font-weight-light text-success">*Contoh : 18/11/2021</p>
								</td>
							</tr>
							<tr>
								<th>Pukul</th>
								<td><input type="time" name="var4" class="form-control" placeholder="Pukul" required>
									<p class="font-weight-light text-success">*Contoh : 08:00</p>
								</td>
							</tr>
						</tbody>
					</table>
