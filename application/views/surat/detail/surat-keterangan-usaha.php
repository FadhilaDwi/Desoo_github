				...
				<?php 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>Nama Usaha</th>
								<td><input type="text" name="var1" class="form-control" placeholder="Nama Usaha" required>
									<p class="font-weight-light text-success">*Contoh : Warung Gorengan</p>
								</td>
							</tr>
							<tr>
								<th>Kegunaan Surat</th>
								<td><input type="text" name="var2" class="form-control" placeholder="Kegunaan Surat" required>
									<p class="font-weight-light text-success">*Contoh : Administrasi Bank</p>
								</td>
							</tr>
						</tbody>
					</table>
