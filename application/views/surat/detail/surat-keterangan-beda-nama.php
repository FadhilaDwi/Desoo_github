				...
				<?php 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>Berkas Yang Bermasalah</th>
								<td><input type="text" name="var1" class="form-control" placeholder="Berkas Yang Bermasalah" required>
									<p class="font-weight-light text-success">*Contoh : Sertifikat dengan Nomor SHM 321</p>
								</td>
							</tr>
							<tr>
								<th>Nama Yang Salah</th>
								<td><input type="text" name="var2" class="form-control" placeholder="Nama Yang Salah" required>
									<p class="font-weight-light text-success">*Contoh : Anang Pepe Abseno</p>
								</td>
							</tr>
						</tbody>
					</table>
