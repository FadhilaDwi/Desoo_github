				...
				<?php 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>Kegunaan</th>
								<td><input type="text" name="var1" class="form-control" placeholder="Kegunaan" required>
									<p class="font-weight-light text-success">*Contoh : persyaratan melamar pekerjaan</p>
								</td>
							</tr>
						</tbody>
					</table>
