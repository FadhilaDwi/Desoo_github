				...
				<?php 
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>Alamat Tujuan</th>
								<td><input type="text" name="var2" class="form-control" placeholder="Alamat Tujuan" required>
									<p class="font-weight-light text-success">*Contoh : Dusun Gajah Mungkur RT 21 RW 05 Desa Manduro Manggung Gajah Kecamatan Ngoro Kabupaten Mojokerto</p>
								</td>
							</tr>
						</tbody>
					</table>
