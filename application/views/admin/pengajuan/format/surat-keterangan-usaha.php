...
<body>
	<center>
		...
		<table>
			<tr>
		       <td colspan="2">
			       <font size="4">&emsp; &emsp; Yang bertanda tangan di bawah ini Kepala Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?>, Menerangkan dengan sebenarnya bahwa yang tersebut dibawah ini :</font>
		       </td>
		    </tr>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut di atas  benar-benar penduduk Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?> dan mempunyai usaha <?php echo $pengajuan->var1 ?>.
					</font>
		       </td><br><br>
		    </tr>
		    <tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; <?php echo $pengajuan->surat ?> ini diminta oleh yang bersangkutan untuk dipergunakan sebagai <?php echo $pengajuan->var2 ?>.
					</font>
		       </td><br><br>
		    </tr>
			<tr>
