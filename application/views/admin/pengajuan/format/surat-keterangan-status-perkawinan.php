...
<body>
	<center>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut diatas benar-benar Penduduk Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?>.
					</font>
		       </td><br><br>
		    </tr>
		    <tr>
			...
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Demikianlah <?php echo $pengajuan->surat ?> ini kami buat dengan sebenarnya dan mohon periksa  adanya.
					</font>
		       </td><br><br>
		    </tr>
		</table>
