...
<body>
	<center>
		...
		<table>
			<tr>
		       <td colspan="2">
			       <font size="4"> &emsp; &emsp; Yang bertanda tangan dibawah ini, Kepala Desa <?php echo $site->namaweb ?>, Kecamatan <?php echo $site->kecamatan ?>, Kabupaten <?php echo $site->kabupaten ?>, menerangkan dengan sebenarnya bahwa :</font>
		       </td>
		    </tr>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut di atas  benar-benar penduduk Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?> dan belum memiliki KTP Elektronik.
					</font>
		       </td><br><br>
		    </tr>
		    <tr>
			...
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Demikianlah <?php echo $pengajuan->surat ?> ini kami buat dengan sebenarnya dan mohon diperiksa  adanya.
					</font>
		       </td><br><br>
		    </tr>
		</table>
