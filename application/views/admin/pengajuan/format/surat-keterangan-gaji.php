...
<body>
	<center>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut diatas benar-benar Penduduk Desa Manduro MG Kecamatan Ngoro Kabupaten Mojokerto yang bekerja sebagai <?php echo $penduduk->pekerjaan ?> dan memiliki penghasilan sebesar Rp <?php echo $pengajuan->var1 ?> per bulan.
					</font>
		       </td><br><br>
		    </tr>
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Demikianlah <?php echo $pengajuan->surat ?> ini kami buat berdasarkan kenyataan dan pengamatan kami, untuk dipergunakan sebagaimana mestinya.
					</font>
		       </td><br><br>
		    </tr>
		</table>
