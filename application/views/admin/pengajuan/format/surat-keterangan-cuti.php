...
<body>
	<center>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Menerangkan dengan sebenarnya bahwa orang tersebut di atas benar-benar penduduk Desa <?php echo $site->namaweb ?>, dan tidak masuk bekerja <?php echo $pengajuan->var1 ?>, pada tanggal <?php echo $pengajuan->var2 ?> dikarenakan <?php echo $pengajuan->var3 ?> dan orang tersebut bekerja di <?php echo $pengajuan->var4 ?> yang beralamat di <?php echo $pengajuan->var5 ?>.
					</font>
		       </td><br><br>
		    </tr>
			<tr>
