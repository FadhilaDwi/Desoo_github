...
<body>
	<center>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut di atas  benar-benar penduduk Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?> dan orang tersebut di atas tergolong orang tidak mampu.
					</font>
		       </td><br><br>
		    </tr>
		    <tr>
