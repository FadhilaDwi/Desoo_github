...
<body>
	<center>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Orang tersebut di atas  benar-benar penduduk dan berdomisili di Desa <?php echo $site->namaweb ?> Kecamatan <?php echo $site->kecamatan ?> Kabupaten <?php echo $site->kabupaten ?>, nama di KTP <?php echo $penduduk->nama_penduduk ?> sedangkan di <?php echo $pengajuan->var1 ?> atas nama <?php echo $pengajuan->var2 ?> adalah satu orang yang sama.
					</font>
		       </td><br><br>
		    </tr>
		    <tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Surat keterangan ini di minta diberikan oleh yang bersangkutan untuk digunakan sebagai Kelengkapan Administrasi.
					</font>
		       </td><br><br>
		    </tr>
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Demikianlah <?php echo $pengajuan->surat ?> ini kami buat dengan sebenarnya dan mohon periksa sebagai mana mestinya.
					</font>
		       </td><br><br>
		    </tr>
		</table>
