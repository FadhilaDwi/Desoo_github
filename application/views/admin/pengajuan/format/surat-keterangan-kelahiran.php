...
<body>
	<center>
		...
		<table>
			...
			<tr>
		       <td colspan="2">
			       <font size="4">Telah lahir seorang anak <?php echo $pengajuan->var5 ?></font>
		       </td>
		    </tr>
		    <tr><td colspan="2"></td></tr><tr><td colspan="2"></td></tr><tr><td colspan="2"></td></tr>
			...
			<tr class="text2">
				<td>Istri Dari</td>
				<td width="525">: <?php echo $pengajuan->var9 ?></td>
			</tr>
			<tr class="text2">
				<td>Alamat</td>
				<td width="525">:  Dusun <?php echo $penduduk->dusun ?> RT <?php echo $penduduk->rt ?> RW <?php echo $penduduk->rw ?> Desa <?php echo $penduduk->kelurahan ?> Kecamatan <?php echo $penduduk->kecamatan ?> Kabupaten <?php echo $site->kabupaten?></td>
		...
		<table width="675">
			<tr>
		       <td>
			      	<font size="4"> &emsp; &emsp; Surat keterangan ini diminta oleh yang bersangkutan karena tidak memiliki Akta Kelahiran dan dalam proses pengurusan di Dispendukcapil Kabupaten <?php echo $site->kabupaten ?>.
					</font>
		       </td><br><br>
		    </tr>
		</table>
